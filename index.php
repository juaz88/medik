                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 wow bounceInUp" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            ...
                            <h4 class="title"><a href="">Realiza un pedido</a></h4>
                            <p class="description">Puedes realizar un pedido seleccionando los productos o escaneando tu formula medica!</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            <div class="icon" style="background: #fff0da;"><i class="ion-ios-bookmarks-outline" style="color: #e98e06;"></i></div>
                            <h4 class="title"><a href="">Ver productos</a></h4>
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            <div class="icon" style="background: #fff0da;"><i class="ion-ios-bookmarks-outline" style="color: #e98e06;"></i></div>
                            <h4 class="title"><a href="">Farmacias</a></h4>
                            <p class="description">Puedes registrar tu farmacia y disfrutar de todos nuestros beneficios!!</p>
                        </div>
                    </div>
